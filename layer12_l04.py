...
Original file is located at
    https://colab.research.google.com/drive/1d36rqE6faj4M7P90itbC70qH1AQhIIo6
"""
...
train_df = pd.read_csv('/content/drive/MyDrive/ML_Project/Layer12/train.csv')
valid_df = pd.read_csv('/content/drive/MyDrive/ML_Project/Layer12/valid.csv')
test_df = pd.read_csv('/content/drive/MyDrive/ML_Project/Layer12/test.csv')
...
joblib.dump(classifier, '/content/drive/MyDrive/ML_Project/pkl_files/layer12_label4.pkl')
...
output_df.to_csv('/content/drive/MyDrive/ML_Project/output_csv/layer12-l04.csv',index=False)